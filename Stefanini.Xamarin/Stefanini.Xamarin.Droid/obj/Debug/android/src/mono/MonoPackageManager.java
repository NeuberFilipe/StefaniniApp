...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Stefanini.Xamarin.Droid.dll" comes first in this list. */
		"Stefanini.Xamarin.Droid.dll",
		"CardView.dll",
		"FormsViewGroup.dll",
		...
		"Square.OkIO.dll",
		"Square.Picasso.dll",
		"Stefanini.BackEnd.Core.Data.dll",
		"Stefanini.BackEnd.Core.Model.dll",
		"Stefanini.BackEnd.Core.Service.dll",
		"Stefanini.Xamarin.Core.dll",
